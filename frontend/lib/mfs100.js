var secureUri = "https://localhost:8003/mfs100/"; // Secure
var nonSecureUri = "http://localhost:8004/mfs100/"; // Non-Secure
var runtimeConfig = window.MFS100_CONFIG || {};
var uri = runtimeConfig.uri || (runtimeConfig.secure ? secureUri : nonSecureUri);

window.SetMFS100Uri = function (nextUri) {
    uri = nextUri || uri;
};

window.GetMFS100Uri = function () {
    return uri;
};
